...
Rails.application.config.assets.precompile += %w( weixin.js )
Rails.application.config.assets.precompile += %w( mobile.css )
Rails.application.config.assets.precompile += %w( mobile.js )
Rails.application.config.assets.precompile += %w( huishequ.css )
Rails.application.config.assets.precompile += %w( aboutus.css )
Rails.application.config.assets.precompile += %w( pc_home.css )